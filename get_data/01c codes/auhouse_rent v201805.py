...
scrape_area_dir =  output_directory + '01a Region href property/' + dateid +'_auhouse'
suburb_dir =  output_directory + '01b Suburb_Files/' + dateid +'_auhouse'
...
master_df.to_csv(final_dir  + '/'+dateid+'_Auhouseprice.csv',index=False)



master_df.query('ID =="32471670" ')
