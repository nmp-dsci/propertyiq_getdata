...
suburb_dir =  output_directory + '01b Suburb_Files/' + dateid +'_domain'
...
#for suburb in suburb_list[rows5]:     # suburb = suburb_list[rows4][0]   suburb = 'kirribilli-nsw-2061'
    ...
    if os.path.exists(suburb_dir+'/'+suburb+'.csv') ==False:
        ...
        # order
        #suburb_files['filename'].str.extract('.*_b({}))
...
#
#
#for c in info_extract.columns.values:
#    print(c)
#    if info_extract[c].dtype == 'O':
#        info_extract[c].str.encode('utf-8',errors='ignore')
#
#
#for i in info_extract[c]:
#    str(i).encode('utf-8',errors='ignore')
#
