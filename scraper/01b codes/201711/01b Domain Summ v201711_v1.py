...
for suburb in suburb_list[rows1]:     # suburb = suburb_list[rows4][0]   suburb = 'kirribilli-nsw-2061'
    if os.path.exists(suburb_dir+'/'+suburb+'.csv') ==False:
        ...
        #
        #
trackerDF.to_csv(output_directory + '01b Suburb_Files/' + dateid +'_domain_row1.csv',index=False)
#### END LOOP 
